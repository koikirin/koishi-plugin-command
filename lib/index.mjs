...
// src/index.ts
import { Argv, escapeRegExp, isNullable, Schema } from "koishi";
var name = "command";
...
var Tokenizer = class {
  ...
  setDefaultTokenizer(tokenizer) {
    ...
    Argv.defaultTokenizer = tokenizer;
    return () => {
...
function apply(ctx, config) {
  ctx.effect(() => {
    ...
    Argv.parse = /* @__PURE__ */ __name(function parse(source, terminator = "", delimiter = /\s+/, contentInitiator = "") {
      return tokenizer.parse(source, terminator, delimiter, contentInitiator);
    }, "parse");
    Argv.stringify = /* @__PURE__ */ __name(function stringify(argv) {
